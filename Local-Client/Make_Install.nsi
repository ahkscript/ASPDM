...
Section "MainSection" SEC01
	...
	WriteRegStr HKCR "ASPDM\shell\open\command" "" '"CustomURI_Handler.exe" "%1"'
...
Section -Post
	...
	WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayIcon" "$INSTDIR\Package_Lister.ahk"
